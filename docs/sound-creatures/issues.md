...
| 完了 | [#133 — 見つけた生き物を編集画面へ連れて行く](https://github.com/TIshow/BeatBubble/issues/133)               | `tasks/06-editor-companion.md` |
...
実装、Production DB migration適用、ログイン状態の保存確認、フローティング相棒UIの
人手確認を完了した。Task 07は別途承認まで開始しない。
