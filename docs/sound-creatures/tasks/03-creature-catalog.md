...
完了。Issue #128、commit `e47ff79` で、全8体の型安全な表示カタログ、日英コピー、
画像・翻訳の対応を検証する単体テストを追加した。PR #131で`main`へ統合し、
2026-08-04にProduction反映を確認した。
...
- `DiscoveryId` ごとに画像パスと演出種別を対応させ、翻訳も同じIDで参照する。
